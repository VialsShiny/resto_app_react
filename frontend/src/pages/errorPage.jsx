...
const ErrorPage = ({ status = 404 }) => {
  switch (status) {
    case 404:
      return (
        <>
          <div class="w-full min-h-screen flex flex-col justify-center items-center px-12 lg:px-16 text-center">
            ...
            <Link to="/" class="bg-[#F54748] text-white text-md font-bold tracking-wide rounded-full px-8 py-2 mt-12 hover:bg-red-600 transition duration-500">
              GO TO HOMEPAGE
            </Link>
          </div>
        </>
      ...
      return (
        <>
          <div class="w-full min-h-screen flex flex-col justify-center items-center px-12 lg:px-16 text-center">
            ...
            <Link href="/" class="bg-[#F54748] text-white text-md font-bold tracking-wide rounded-full px-8 py-2 mt-12 hover:bg-red-600 transition duration-500">
              GO TO HOMEPAGE
            </Link>
          </div>
        </>
